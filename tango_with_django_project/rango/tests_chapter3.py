...
class Chapter3AboutPageTests(TestCase):
    ...
    def test_for_index_hyperlink(self):
        ...
        self.assertTrue(single_quotes_check or double_quotes_check, f"{FAILURE_HEADER}We could not find a hyperlink back to the index page in your about view. Check your about.html template, and try again.{FAILURE_FOOTER}")</pre></body></html>Ztext/plainUUTF-8_phttps://raw.githubusercontent.com/tangowithcode/tango_with_django_2_code/master/progress_tests/tests_chapter3.py    ( ? Q g Ö î ï&¥&ø&≈             
              '8
